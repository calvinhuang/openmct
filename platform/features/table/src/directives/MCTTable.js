...
import MCTTableController from '../controllers/MCTTableController';
import TableTemplate from 'raw-loader!../../res/templates/mct-table.html';
 ...
 * @constructor
 */
export default function MCTTable() {
    return {
        restrict: "E",
